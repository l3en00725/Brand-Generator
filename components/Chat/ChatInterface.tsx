        ...
        <div className="relative max-w-3xl mx-auto">
          <div className="relative">
            <input
              ...
              className="w-full bg-dark-800 text-white placeholder-gray-500 border border-white/10 rounded-full py-4 pl-6 pr-14 focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500/50 shadow-lg transition-all"
            ...
            <button
              ...
              className="absolute right-2 top-1/2 -translate-y-1/2 p-2.5 bg-white text-dark-900 rounded-full hover:bg-gray-200 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm"
            >
              <Send size={18} />
            </button>
          </div>
